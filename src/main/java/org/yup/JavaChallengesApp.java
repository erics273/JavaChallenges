...
//Doing to show you an import for now but this is not required since both are in the
//package
...
//          int sumOfpotatoes =  challenges.addTwoNumbers();
//          System.out.println(sumOfpotatoes);

//            int differenceOfpotatoes =  challenges.subtractTwoNumbers();
//            System.out.println(differenceOfpotatoes);
